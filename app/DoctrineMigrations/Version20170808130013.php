 ...
 */
class Version20170808130013 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE review ADD company_id INT DEFAULT NULL, DROP company');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE review ADD company VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, DROP company_id');
    }
}
